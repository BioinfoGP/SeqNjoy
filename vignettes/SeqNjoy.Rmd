...
# Install SeqNjoy with vignettes, set build_vignettes = TRUE during the installation
...
1. Download the gzipped package source code SeqNjoy_`r utils::packageVersion("SeqNjoy")`.tar.gz available at [BioinfoGP’s GitHub repository](https://github.com/BioinfoGP/SeqNjoy).
